...
namespace RSAHyundai.Data
{
    public class AppDbContext : DbContext
    {
        ...
        {
            var connectionString = "Server=localhost;Database=Hyundai;User Id=homestead;Password=secret;Port=33060;";
            optionsBuilder.UseMySql(connectionString, new MySqlServerVersion(new System.Version(8, 0, 35)));
